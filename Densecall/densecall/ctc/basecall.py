...
def basecall(model, reads, rna=False, beamsize=5, chunksize=0, overlap=0, batchsize=1, qscores=False, reverse=None):
    """
    ...
    decoder = partial(decode, decode=model.decode, rna=rna,  beamsize=beamsize, qscores=qscores, stride=model.stride)
...
def decode(scores, decode, rna=False, beamsize=5, qscores=False, stride=1):
    """
