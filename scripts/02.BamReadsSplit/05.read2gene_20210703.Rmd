...
BamFile <- "/mnt/raid5/Personal/tangchao/project/Nanopore/BarcodeDecomplex/data/alignment/20210703/minimap2/20210703.sorted.bam"
scanBamWhat()
...
```{r}
library(openxlsx)
Mat <- openxlsx::read.xlsx("/mnt/raid5/Personal/tangchao/project/Nanopore/BarcodeDecomplex/data/Meta/Barcode_and_RNA_information.xlsx", sheet = 5)
Mat <- Mat[, c(1, 2, 5)]
...
Mat[is.na(Freq), Freq := 0]
setkey(Mat, Barcode)
```

```{r}
fwrite(x = read2gene, file = "/mnt/raid5/Personal/tangchao/project/Nanopore/BarcodeDecomplex/analysis/02.BamReadsSplit/read2gene_20210703.txt", row.names = F, quote = F, sep = "\t")
write.xlsx(Mat, "/mnt/raid5/Personal/tangchao/project/Nanopore/BarcodeDecomplex/analysis/02.BamReadsSplit/reads_pergene_20210703.xlsx")
```
...
```{r}
library(ShortRead)
reads <- ShortRead::readFastq("/mnt/raid5/Personal/tangchao/project/Nanopore/BarcodeDecomplex/data/BaseCall/20210703/guppy/fast5_pass/fast5_pass.fastq")
...
for(g in unique(read2gene$Barcode)) {
  ...
  ShortRead::writeFastq(reads_g, file = paste0("/mnt/raid5/Personal/tangchao/project/Nanopore/BarcodeDecomplex/analysis/02.BamReadsSplit/20210703/", g, ".fq.gz"))
}
```
