...
```{r fig.width=4, fig.height=4}
pdf("/mnt/raid5/Personal/tangchao/project/Nanopore/BarcodeDecomplex/analysis/06.DecodingDeePlexiConAndPoreplex/01.Comparison/Our_Poreplex_confusionMatrix_V2.pdf", width = 4, height = 4)
pheatmap(t(confP * 100), 
         cluster_rows = F, 
         cluster_cols = F, 
         display_numbers = T, 
...
```{r fig.width=4, fig.height=4}
pdf("/mnt/raid5/Personal/tangchao/project/Nanopore/BarcodeDecomplex/analysis/06.DecodingDeePlexiConAndPoreplex/01.Comparison/Poreplex_confusionMatrix_V2.pdf", width = 4.2, height = 4)
pheatmap(t(confP2[, 1:4]*100), 
         cluster_rows = F, 
         cluster_cols = F, 
         display_numbers = T, 
